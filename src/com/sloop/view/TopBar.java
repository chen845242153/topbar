...
public class TopBar extends RelativeLayout {
	...
	public void rightButtonsetvisili(boolean flag) {
		if (flag) {
			rightButton.setVisibility(View.VISIBLE);
		} else {
			rightButton.setVisibility(View.GONE);
	...
	public TopBar(Context context, AttributeSet attrs) {
		...
		// 取出自定义属性 - 左侧
		leftTextColor = ta.getColor(R.styleable.TopBar_leftTextColor,
				Color.BLACK);
		...
		// 取出自定义属性 - 标题
		titleTextColor = ta.getColor(R.styleable.TopBar_titleTextColor,
				Color.BLACK);
		...
		// 设置布局 - 右
		rirhtParams = new LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
